...
9.126886^2 / (9.126886^2 + 9.713318^2)
...
We use 5-fold Cross validation to calculate the Root Mean Squared Error (RMSE) = 11.3. Meaning that on average the model makes an error of 11.3 NDI when predicting
